      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 ">
        {cases.map((item, index) => (
          <motion.article
            ...
            className="rounded-xl overflow-hidden p-2 bg-accent border-2 border-base-200  md:hover:bg-accent active:scale-[0.99] focus-visible:ring-2 focus-visible:ring-primary transition-shadow duration-300 ease-in-out shadow-md hover:shadow-xl "
          >
            <Link
            ...
            >
              ...
              <div className="p-5 flex flex-col justify-evenly min-h-[200px]">
                ...
                <p className="text-sm text-zinc-300 line-clamp-4 tracking-wide">
                  {item.desc}
                </p>
                <div className="text-xs font-semibold text-zinc-400 flex justify-between pt-4">
