...
const PriceEstimator = () => {
  ...
  return (
    <div className="p-6 max-w-md mx-auto bg-base-200 rounded-2xl shadow-lg">
      ...
      <div className="text-lg mb-1">
        VAT ({vatInfo.name} - {vatRate * 100}%):{" "}
        <span className="font-semibold">€{taxAmount}</span>
      </div>
      <div className="text-2xl font-bold mb-4">
        Total incl. VAT: <span>€{totalWithTax}</span>
      </div>
      ...
      <p className="text-sm italic text-gray-500 mt-4">
        Disclaimer: The price shown is only an estimation and may vary. Final
        pricing will be confirmed upon consultation.
      </p>
    </div>
  );
};
