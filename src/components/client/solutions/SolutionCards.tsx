    ...
    <div className="grid grid-cols-1 place-items-center xl:grid-cols-2 gap-10 w-full max-w-7xl">
      {solutions.map((solution, index) => (
        ...
        >
          <Link
            href={solution.href}
            className="flex flex-row rounded-xl bg-base-200/80 ring-2 p-2 ring-base-200 md:hover:bg-base-200 active:scale-[0.99] focus-visible:ring-2 focus-visible:ring-primary transition-all duration-300 ease-in-out gap-3 shadow-lg relative max-w-[650px] xl:max-w-[500px]"
            aria-label={t(
